...
public class Verbo {
	public static void main (String[]args) 
	{
		...
		if(verbo.endsWith("ar")) 
		{
			...
			System.out.println(verbo.substring(0, 1).toUpperCase()+verbo.substring(1)+ " tt"); // ele pega o índice 0 e para no 1, ou seja, pega só o 0, coloca em maíusculo, e dps, printa o resto da strign apartir do 1, com o outro substring assim é mais fácil
		}
